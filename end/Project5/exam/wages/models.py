...
class Workers(models.Model):
    ...
    wages = models.PositiveIntegerField(verbose_name='本月工资')
    # job_number = models.PositiveIntegerField(max_length=10, verbose_name='工号')
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name="所属部门",related_name="workers")
